...
def evaluate_canshield(args : DictConfig) -> None:
    ...
    args.scaler_dir = os.path.join(root_dir.parent, args.scaler_dir)
    print("Current working dir: ", args.root_dir)      
    # Generated all the thresholds for different factors....  
    args.data_dir = os.path.join(root_dir.parent, args.train_data_dir) # target data
    ...
    args.data_dir = os.path.join(root_dir.parent, args.test_data_dir) # target test data
