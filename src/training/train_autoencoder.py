...
def train_autoencoder(args, file_index, autoencoder, x_train_seq):
    ...
    checkpoint_path = f"{root_dir.parent}/artifacts/model_ckpts/{dataset_name}/autoendoer_canshield_{dataset_name}_{time_step}_{num_signals}_{sampling_period}.h5"
    keras_callbacks   = [
    ...
    visualize_dir = Path(f"{root_dir.parent}/artifacts/visualize/{dataset_name}/performance_canshield_{dataset_name}_{time_step}_{num_signals}_{sampling_period}_{file_index+1}.jpg")
    history_dir = Path(f"{root_dir.parent}/artifacts/histories/{dataset_name}/history_canshield_{dataset_name}_{time_step}_{num_signals}_{sampling_period}_{file_index+1}.json")
