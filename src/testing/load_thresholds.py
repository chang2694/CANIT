...
def get_existing_threshold_data(args):
    ...
    for time_step in time_steps:
        for sampling_period in sampling_periods:
            ...
            loss_th_dir = f'{root_dir.parent}/data/thresholds/{dataset_name}/{loss_th}'
            ...
            for loss_factor in loss_factors:
                ...
                time_th_dir = f'{root_dir.parent}/data/thresholds/{dataset_name}/{time_th}'
                try:
                ...
                for time_factor in time_factors:
                    ...
                    signal_th_dir = f'{root_dir.parent}/data/thresholds/{dataset_name}/{signal_th}'
...
def generate_and_save_prediction_loss_per_file(args, file_name, file_path, run_type):
    ...
    if dataset_name =='syncan':
        model_dir = f"{root_dir.parent}/artifacts/models/{dataset_name}/autoendoer_canshield_{dataset_name}_{time_step}_{num_signals}_{sampling_period}.h5"
